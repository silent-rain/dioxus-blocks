...
impl CardView {
    ...
    fn footer_and_body_card(&self) -> Card {
        Card::new()
            ...
            .footer(View::new().childrens2(vec![Text::p("Footer content")]))
            .style(|s| s.margin_top("32px"))
    }
                ...
                View::new()
                    ...
                    .childrens2(vec![
                        Card::new()
                            ...
                            .childrens2(vec![Text::p("Always Shadow")])
                            .style(|s| s.width("200px")),
                        Card::new()
                            .shadow(CardShadow::Hover)
                            .childrens2(vec![Text::p("Hover Shadow")])
                            .style(|s| s.width("200px")),
                        Card::new()
                            .shadow(CardShadow::Never)
                            .childrens2(vec![Text::p("No Shadow")])
                            .style(|s| s.width("200px")),
                    ]),
            ])
            .style(|s| s.margin_top("32px"))
